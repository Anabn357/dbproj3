...
function makeResponsive() {
  ...
  function updateToolTip(chosenXAxis, circlesGroup) {
    ...
    var toolTip = d3.tip()
      ...
      .offset([80, -60])
      .html(function(d) {
        return (`${d.state}<br>${label} ${d[chosenXAxis]}<br>Global_Sales: ${d.healthcareHigh}`);
      });
  ...
  (async function(){
    ...
    var CriticScoreLabel = labelsGroup.append("text")
      .attr("x", 0)
      .attr("y", 20)
    ...
    var GameScoreLabel = labelsGroup.append("text")
      .attr("x", 0)
      .attr("y", 40)
